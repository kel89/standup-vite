        ...
        <div className="relative">
            <div className="bg-white px-6 sm:px-12 fixed top-0 w-full border-bottom shadow-xl left-0 right-0">
                ...
                <div className="mx-auto max-w-7xl px-6 lg:px-8 pb-6">
                    ...
                    <button
                        className="bg-teal-500 block mx-auto font-black text-white text-sm mt-5 tracking-wider py-2 px-12 rounded shadow-xl hover:bg-teal-900 hover:shadow-xl transition uppercase"
                        onClick={() => setGoing(!going)}
                    >
                        toggle
                    </button>
                    <a
                        href="https://app.clickup.com/2277049/dashboards/25fnt-1410"
                        target="_blank"
                        rel="noreferrer"
                        className="text-teal-500 mt-3 text-sm font-bold uppercase block mx-auto text-center"
                    >
                        dashboard &rarr;
                    </a>
                </div>
